...
<input type="hidden" id="cataLog1" value="${queryCategoryLevel1 }">
<input type="hidden" id="cataLog2" value="${queryCategoryLevel2 }">
<input type="hidden" id="cataLog3" value="${queryCategoryLevel3 }">
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					APP 信息管理维护 <i class="fa fa-user"></i><small>${DEV_USER_SESSION.devName}
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="queryStatus" class="form-control">
									<c:if test="${appStaus != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="dataDictionary" items="${appStaus}">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="queryFlatformId" class="form-control">
									<c:if test="${appFlatfrom != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="dataDictionary" items="${appFlatfrom}">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="queryCategoryLevel1" name="queryCategoryLevel1" class="form-control">
									<c:if test="${oneMenu != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="appCategory" items="${oneMenu}">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/jump/junmpListAdd" class="btn btn-success btn-sm">新增APP基础信息</a>
					<a href="${pageContext.request.contextPath}/devuser/downExecel" class="btn btn-success btn-sm">导出Excel表</a>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							...
							${page.pageIndex }/${page.pageCount }页</div>
					</div>
					<div class="col-sm-7">
							...
							<ul class="pagination">
								<c:if test="${page.pageIndex > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${page.pageIndex-1});"
								...
								<c:if test="${page.pageIndex < page.pageCount }">
									...
									<li class="paginate_button next"><a
										href="javascript:page_nav(document.forms[0],${page.pageCount });"
